...
//adapter to display steplist in recyclerview
public class EditAdapter extends RecyclerView.Adapter<EditViewHolder> implements ItemTouchHelperAdapter {
    ...
    //constructor
    public EditAdapter(Context context, List<String> stepList, OnDragStartListener mDragStartListener) {
        this.context = context;
        this.stepList = stepList;
        this.mDragStartListener = mDragStartListener;
    }

    //set row layout for recyclerview
    @Override
    public EditViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View item = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_add_steps,
                        parent,
                        false);
        return new EditViewHolder(item);
    }
